      ...
      <div class="flex">
        <?php if(has_category() ) {
          ...
          foreach($cats as $cat){
            ...
            <?php $args = array(
              'post_type' => 'post',
              'posts_per_page' => '3',  'post__not_in' =>array( $post->ID ), 'category__in' => $catkwds,
              'orderby' => 'rand'
              );
        ...
        <?php if( has_post_thumbnail() ): ?>
          ...
          <div class="text-content">
            ...
            <div class="article-tags">
              <p class="article-tags__inner"><?php $posttags=get_the_tags();if($posttags){foreach($posttags as $tag){echo '<span class="tag-span">'.$tag->name.'</span>';}} ?></p> 
